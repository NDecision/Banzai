...
namespace Banzai.Ioc.Ninject.Test
{
    public class WhenFlowAddsShouldExecuteBlock
    {
        ...
        public void ShouldExecute_Is_Added_To_Root_Node()
        {
            ...
            ((IShouldExecuteBlock<object>) flowRootNode.ShouldExecuteBlock)
                .ShouldExecuteAsync(new ExecutionContext<object>(new object())).Result.Should().BeFalse();
        }
        ...
        public void ShouldExecute_Is_Added_To_Child_Node()
        {
            ...
            ((IShouldExecuteBlock<object>) subflow.ShouldExecuteBlock)
                .ShouldExecuteAsync(new ExecutionContext<object>(new object())).Result.Should().BeFalse();
        }
        ...
        public void Adding_ShouldExecute_To_Subflow_Applies_To_Subflow_Root()
        {
            ...
            ((IShouldExecuteBlock<object>) subflowRoot.ShouldExecuteBlock)
                .ShouldExecuteAsync(new ExecutionContext<object>(new object())).Result.Should().BeFalse();
        }
    }
}